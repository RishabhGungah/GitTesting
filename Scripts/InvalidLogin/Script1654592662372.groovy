...
CustomKeywords.'InputCred.cred'()

//Click on Login on Webview
Mobile.tap(findTestObject('Object Repository/android.widget.Button - Log In'), 0)

//Verify Error message
Mobile.waitForElementPresent(findTestObject('Object Repository/android.view.View - WRONG EMAIL OR PASSWORD'), 10)

Mobile.verifyElementText(findTestObject('Object Repository/android.view.View - WRONG EMAIL OR PASSWORD'), GlobalVariable.errMesg)
