...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Gradient 1</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Gradient #1' or . = 'Gradient #1')]</locator>
