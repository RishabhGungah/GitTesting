...
<MobileElementEntity>
   ...
   <name>android.widget.TextView -  - Nothing to See Here -</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = ' - Nothing to See Here - ' or . = ' - Nothing to See Here - ')]</locator>
